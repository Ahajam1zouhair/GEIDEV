                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text"
                                                    ...
                                                    name="matricule" value="{{ $stagiaire->matricule }}" />
                                                @error('matricule')
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select @error('niveau') is-invalid @enderror"
                                                ...
                                                name="niveau">
                                                <option value="NIVEAU TECHNICIEN SPECIALISE"
                                                    {{ $stagiaire->niveau === 'NIVEAU TECHNICIEN SPECIALISE' ? 'selected' : '' }}>
                                                    NIVEAU TECHNICIEN SPECIALISE</option>
                                                <option value="NIVEAU TECHNICIEN"
                                                    {{ $stagiaire->niveau === 'NIVEAU TECHNICIEN' ? 'selected' : '' }}>
                                                    NIVEAU TECHNICIEN</option>
                                                <option value="NIVEAU QUALIFICATION"
                                                    {{ $stagiaire->niveau === 'NIVEAU QUALIFICATION' ? 'selected' : '' }}>
                                                    NIVEAU QUALIFICATION</option>
                                            </select>
                                            @error('niveau')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
